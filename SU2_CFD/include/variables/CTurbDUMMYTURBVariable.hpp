/*!
 * \file CTurbDUMMYTURBVariable.hpp
...
class CTurbDUMMYTURBVariable final : public CTurbVariable {
...
public:
   ...
   */
  CTurbDUMMYTURBVariable(su2double val_nu_tilde, su2double val_muT, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config);
