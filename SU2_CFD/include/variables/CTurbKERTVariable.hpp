...
class CTurbKERTVariable final : public CTurbVariable {
...
public:
   ...
   */
  CTurbKERTVariable(su2double val_nu_tilde, su2double val_muT, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbKERTVariable() override = default;
