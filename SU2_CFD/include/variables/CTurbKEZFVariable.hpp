/*!
 * \file CTurbKEZFVariable.hpp
 * \brief Declaration of the variables of the Development turbulence model.
 * \author L. Cavanha
...
class CTurbKEZFVariable final : public CTurbVariable {
...
public:
   ...
   */
  CTurbKEZFVariable(su2double val_nu_tilde, su2double val_muT, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbKEZFVariable() override = default;
