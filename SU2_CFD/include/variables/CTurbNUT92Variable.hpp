...
class CTurbNut92Variable final : public CTurbVariable {
...
public:
   ...
   */
  CTurbNut92Variable(su2double foo, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbNut92Variable() override = default;
