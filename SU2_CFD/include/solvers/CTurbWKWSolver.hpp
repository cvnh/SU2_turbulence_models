/*!
 * \file CTurbWKWSolver.hpp
 * \brief Headers of the CTurbWKSSolver class
 * \author L. Cavanha
...
/*!
 * \class CTurbWKWSolver
 * \brief Main class for defining the turbulence model solver.
 * \ingroup Turbulence_Model
 * \author L. Cavanha
 */
class CTurbWKWSolver final : public CTurbSolver {
  
private:
  wkw_constants wkw_const;
...
public:
   ...
   */
  CTurbWKWSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbWKWSolver() = default;
  ...
  /*!
   * \brief Get the constants for the WKW model.
   * \return A pointer to an array containing a set of constants
   */
  //inline const struct* GetConstants() const override { return constants; }
