/*!
 * \file CTurbKERTSolver.hpp
 * \brief Headers of the CTurbKERTSolver class
 * \author L. Cavanha
...
/*!
 * \class CTurbKERTSolver
 * \brief Main class for defining the TurbKERT model solver.
 * \ingroup Turbulence_Model
 * \author L. Cavanha
 */

class CTurbKERTSolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTurbKERTSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbKERTSolver(void) = default;
