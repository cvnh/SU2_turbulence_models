/*!
 * \file CTurbCKESolver.hpp
 * \brief Headers of the CTurbCKESolver class
 * \author L. Cavanha
...
/*!
 * \class CTurbCKESolver
 * \brief Main class for defining the TurbCKE model solver.
 * \ingroup Turbulence_Model
 * \author L. Cavanha
 */

class CTurbCKESolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTurbCKESolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbCKESolver(void) = default;
