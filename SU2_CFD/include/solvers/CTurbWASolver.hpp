/*!
 * \file CTurbWASolver.hpp
 * \brief Headers of the CTurbWASolver class
 * \author L. Cavanha
...
/*!
 * \class CTurbWASolver
 * \brief Main class for defining the TurbWA model solver.
...
public:
   ...
   */
  CTurbWASolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbWASolver(void) = default;
