/*!
 * \file CTurbKEZFSolver.hpp
 * \brief Headers of the CTurbKEZFSolver class
 * \author L. Cavanha
...
/*!
 * \class CTurbKEZFSolver
 * \brief Main class for defining the TurbKEZF model solver.
 * \ingroup Turbulence_Model
 * \author L. Cavanha
 */

class CTurbKEZFSolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTurbKEZFSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbKEZFSolver(void) = default;
