/*!
 * \file CTurbKKLSolver.hpp
 * \brief Headers of the CTurbKKLSolver class
 * \author L. Cavanha
...
/*!
 * \class CTurbKKLSolver
 * \brief Main class for defining the TurbKKL model solver.
 * \ingroup Turbulence_Model
 * \author L. Cavanha
 */

class CTurbKKLSolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTurbKKLSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbKKLSolver(void) = default;
