/*!
 * \file CTurbNut92Solver.hpp
 * \brief Headers of the CTurbNut92Solver class
 * \author L. Cavanha
...
/*!
 * \class CTurbNut92Solver
 * \brief Main class for defining the TurbNut92 model solver.
 * \ingroup Turbulence_Model
 * \author L. Cavanha
 */
class CTurbNut92Solver final : public CTurbSolver {
private:
...
public:
   ...
   * \param[in] FluidModel* 
   */
  CTurbNut92Solver(CGeometry *geometry, CConfig *config, unsigned short iMesh, CFluidModel* FluidModel);

  /*!
   * \brief Destructor of the class.
   */
  ~CTurbNut92Solver(void) = default;
