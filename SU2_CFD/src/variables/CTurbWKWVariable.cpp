...
CTurbWKWVariable::CTurbWKWVariable(su2double kine, su2double omega, su2double mut, unsigned long npoint, unsigned long ndim, unsigned long nvar, const wkw_constants wkw_const, CConfig *config)
...
void CTurbWKWVariable::SetBlendingFunc(unsigned long iPoint, su2double val_viscosity,
